<template>
        ...
        <main class="flex justify-between items-center p-4 max-w-6xl mx-auto">
            ...
            <main class="flex md:hidden gap-2 items-center justify-center py-3 text-sm font-medium text-gray-700">
              <a href="/" class="rounded-md px-4 py-2 bg-gray-200 hover:bg-gray-300 cursor-pointer">Beranda</a>
              <a href="/mangapopuler" class="rounded-md px-4 py-2 bg-gray-200 hover:bg-gray-300 cursor-pointer flex gap-2 items-center">
                <img class="w-7" src="../assets/img/jepang.webp" alt="">Manga 
              </a>
              <a href="/manhwapopuler" class="rounded-md px-4 py-2 bg-gray-200 hover:bg-gray-300 cursor-pointer flex gap-2 items-center">
                <img class="w-7" src="../assets/img/korea.webp" alt="">Manhwa 
              </a>
            </main>
            ...
            <div v-else> 
              ...
              <div class="flex justify-between mt-10">
                <button
                  ...
                  class="px-5 py-2 bg-gray-300 rounded-md hover:bg-gray-400 disabled:opacity-50 font-medium"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 dark:text-black text-white"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" /></svg>
                </button>
                <button
                  @click="nextChapter"
                  class="px-5 py-2 bg-gray-300 rounded-md hover:bg-gray-400 font-medium"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 dark:text-black text-white"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" /></svg>
                </button>
              </div>
            </div>
          </div>
